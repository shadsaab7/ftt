                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="#" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="/public/Dashboard/images/logo.png" srcset="./images/logo2x.png 2x" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="/public/Dashboard/images/FTT_Online_Logo@640.png" srcset="./images/logo-dark2x.png 2x" alt="logo-dark">
                            </a>
                        </div>
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Ftt-online panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-note-s2 text-center pt-4"> If Password Is Not Remember <a href="/">Forget Password</a>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; <?= date('Y') ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
