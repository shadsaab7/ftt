...
<div class="main_slider js_height">
	<div class="slider_wrap" id="main_slider_wrap">
		<div class="slide">
			<div class="bg-img" style="background-image: url(/public/img/banner1.jpg)"></div>
			<div class="wrap">
				<div class="wrap_float js_height">
					<div class="slide_content">
						...
						<div class="buttons">
							...
							<a href="javascript:void(0);" onclick="enquiryVisa()" class="link" data-bs-toggle="modal" data-bs-target="#exampleModal"><span>Enquiry Now</span></a>
				...
				<div class="wrap_float text-white mt-5 mb-5">
					...
					<div class="row justify-content-md-center">
						...
						<p class="text-center col-md-8">
							<a href="http://fttonline.in/"><strong>fttonline.in</strong></a> is the fast growing India based online flight ticket booking
						...
						<div class="col-md-2 mt-3 text-center">
							...
							<a href="<?= route_to('about_us') ?>" class="btn btn-info">Read More</a>
						</div>
						<div class="col-md-5">
						</div>
					</div>
...
<div class="most_popular">
	<div class="wrap">
		<div class="wrap_float">
			<div class="title_wrap">
				<h2 class="title">Most Popular Visa</h2>
				<p class="subtitle">
	...
	<div class="wrap">
		<div class="wrap_float">
			<div class="subscribe_block" style="background-image: url(public/img/bus-banner.png)">
				<div class="left">
					<h2 class="_title" id="bus">Bus Booking</h2>
					<p class="_subtitle">For More Bus Enquiry</p>
				</div>
				<div class="right">
					<span>
						<a href="javascript:void(0);" class=" btn bg-danger btn-lg text-white" onclick="budBooking()" data-bs-toggle="modal" data-bs-target="#exampleModal">Enquiry</a>
					</span>
			...
			<form action="<?= route_to('enquiry') ?>" method="post" enctype="multipart/form-data">
				<div class="modal-body px-5">
					<div class="mb-3">
						...
						<input type="text" class="form-control" name="name" placeholder="Name" maxlength="20" required>
					</div>
					<div class="mb-3">
						<label class="form-label">Mobile</label>
						<input type="number" class="form-control" maxlength="10" minlength="10" name="phone" placeholder="Mobile" required>
					</div>
					<div class="mb-3">
						<label class="form-label">Passport Copy</label>
						<input type="file" class="form-control" name="passport_copy" placeholder="Passport Copy" required>
					</div>
					<div class="mb-3">
						<label class="form-label">Country</label>
						<input type="text" class="form-control" name="country" placeholder="Country" maxlength="15" required>
					</div>
					<div class="mb-3">
...
<script>
	...
	<?php if (session()->getFlashdata("success_register")) { ?>
		$(".popup").removeClass("opened"), $("#register-success").addClass("opened");

	<?php } ?>
	<?php if (session()->getFlashdata("forget_password")) { ?>
		$(".popup").removeClass("opened"), $("#forget-password").addClass("opened");

	<?php } ?>
	<?php if (session()->getFlashdata("password_changed")) { ?>
		$(".popup").removeClass("opened"), $("#password-changed").addClass("opened");

	<?php } ?>
	<?php if (session()->getFlashdata("user_not_exist")) { ?>
	...
	function userProfile(id) {
		...
		$.ajax({
			type: 'POST',
			url: '<?= base_url(route_to('user_profile')); ?>',
			data: {
				show: 'show',
				id: id
			},
