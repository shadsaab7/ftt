                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                            ...
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    ...
                                                    <th class="nk-tb-col tb-col-md"><span class="sub-text">Surename</span></th>
                                                            ...
                                                            <ul class="nk-tb-actions gx-1">
                                                                <li>
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a href="javascript:void(0);" onclick="deleteData(<?= $details['id'] ?>)"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url(route_to('user_login')); ?>',
                        data: {
                            delete: 'del',
                            id: id
                        },
